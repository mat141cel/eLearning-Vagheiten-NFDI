...
## Wofür steht die Abkürzung "FAIR" im Zusammenhang mit Forschungsdaten? {.quiz-question}

- Format, Analyze, Integrate, Recap 
- [Findable, Accessible, Interoperable, Reusable ]{.correct}
- Forschungsdaten, Ansätze, Informationen, Referenzen
- Fachliche Auswertung von Informationen in Rechenzentren

::: {.quiz data-question="What command adds an extension to a project?"}
- [ ] quarto install
- [x] quarto add
- [ ] quarto get
:::
...
::: {.quiz data-question="Which of these is a Quarto output format?"}
- [ ] Word
- [x] HTML
- [x] Revealjs
- [ ] Excel
